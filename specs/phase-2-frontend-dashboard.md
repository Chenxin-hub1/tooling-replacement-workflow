...
Portfolio 表格、多维筛选、My actions、Management、Reminders 和 Admin · People & functions 均直接使用原样板的 HTML/CSS/JavaScript；保留字体、配色、布局、文案、列顺序和原响应式规则。不增加卡片视图或独立 Data exchange 页面。
